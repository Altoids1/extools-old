...
//
#define MINIMUM_TRIT_OXYBURN_ENERGY 		2000000.0f
#define TRITIUM_MINIMUM_RADIATION_ENERGY	0.1f
#define TRITIUM_BURN_OXY_FACTOR				100.0f
#define TRITIUM_BURN_TRIT_FACTOR			10.0f
#define TRITIUM_BURN_RADIOACTIVITY_FACTOR	50000.0f
//
#define FIRE_MINIMUM_TEMPERATURE_TO_EXIST	373.15f
#define FIRE_HYDROGEN_ENERGY_RELEASED		560000.0f
//
#define MINIMUM_HEAT_CAPACITY				0.0003f
#define MINIMUM_MOLE_COUNT					0.01f
//
#define CELL_VOLUME				2500.0f	//liters in a cell
#define REACTING 1.0f
#define NO_REACTION 0.0f
